...
%		\begin{align*}
%			P &= \frac{F}{A}\\
%			&= \frac{8.03\text{ kN}}{\pi(0.0635\text{ m})^2/4}\\
%			&= 2\,589.3\text{ kN/m}^2\\
%			&\approx 2.59\text{ MPa}
%		\end{align*}
%	}
...
%			P_A & = & P_B-\Delta p\\
%			& = & 0-\gamma h\\
%			& = & -(8.89\text{ kN/m}^3)(0.30\text{ m})\\
%			& = & -2.667\text{ kPa}\\
%			\\
%			P_{A(abs)} & = & P_{atm}+P_{A(gauge)}\\
%			& = & 102.1\text{ kPa}-2.667\text{ kPa}\\
%			& = & 99.43\text{ kPa}
%		\end{eqnarray*}		
%	}
%	
...
%			P_C & = & P_C-\Delta p\\
%			& = & 0-\gamma h\\
%			& = & -(8.89\text{ kN/m}^3)(0.950\text{ m})\\
%			& = & -8.4455\text{ kN/m}^2\\
%			& \approx & -8.45\text{ kPa}\\
%			\\
%			P_{C(abs)} & = & P_{atm}+P_{C(gauge)}\\
%			& = & 102.1\text{ kPa}-8.4455\text{ kPa}\\
%			& = & 93.65\text{ kPa}
%		\end{eqnarray*}	
%	}
%	\parb
...
%			P_D & = & P_B+\Delta p\\
%			& = & 0+\gamma h\\
%			& = & (8.89\text{ kN/m}^3)(1.375\text{ m})\\
%			& = & 12.224\text{ kPa}\\
%			\\
%			P_{D(abs)} & = & P_{atm}+P_{D(gauge)}\\
%			& = & 102.1\text{ kPa}+12.224\text{ kPa}\\
%			& = & 114.3\text{ kPa}
%		\end{eqnarray*}
%		}
%		\parb
...
%				P_E & = & P_B+\Delta p\\
%				& = & 0+\gamma h\\
%				& = & (8.89\text{ kN/m}^3)(2.0\text{ m})\\
%				& = & 17.78\text{ kPa}\\
%				\\
%				P_{E(abs)} & = & P_{atm}+P_{D(gauge)}\\
%				& = & 102.1\text{ kPa}+17.78\text{ kPa}\\
%				& = & 119.9\text{ kPa}
%			\end{eqnarray*}
%		}	
\end{minipage}
