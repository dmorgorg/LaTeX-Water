...
\begin{minipage}[t]{0.55\columnwidth}
	...
	\Large
	\cbox{
		\textbf{Pressure at oil-water boundary}:
		\begin{eqnarray*}
			P_{O-W} & = & \gamma h = (0.93)\left(9.81\text{ kN/m}^{3}\right)(0.50\text{ m})\\
			& = & 4.5617\text{ kPa}
		\end{eqnarray*}
		\textbf{Pressure at bottom of the barrel}:
		\begin{eqnarray*}
			P_{BB} & = & P_{O-W}+\left(9.81\text{ kN/m}^3\right)(1.0\text{ m})\\
			& = & 4.5617\text{ kPa}+9.81\text{ kPa}\\
			& = & 14.372\text{ kPa}
		\end{eqnarray*}
		\textbf{Force on the bottom of the barrel}:
		\begin{eqnarray*}
			P_{BB} & = & 14.372\text{ kPa}\\
			F & = & pA = (14.372\text{ kN/m}^{2})\cdot\frac{\pi(1.3\text{ m})^2}{4}\\
			& = & 19.076\text{ kN}\\
			F & \thickapprox & 19.08\text {kN}
		\end{eqnarray*}
	}
\end{minipage}
...
\begin{minipage}[c]{0.5\textwidth}
	...
	\cbox[0.9]{
		\Large
		The upper row of bolts is at a depth of $2.4\,\text{m}$ and the lower row is at $3.2\,\text{m}$.\par\bigskip
		The upper row of bolts is $0.41071\,\text{m}$ above the centre of pressure\par\bigskip
		The lower row of bolts is $0.38929\,\text{m}$ below the centre of pressure\par\bigskip
	}
	\par\vspace{0.5cm}
...
% 		the counterclockwise moment of the hydrostatic force on the horizontal section of the gate.\par\bigskip
% 		The dimensions of the vertical rectangle are $1.75\,\text{m}\times1.5\,\text{m}$ and the dimensions of the
% 		horizontal rectangle are  $1.75\,\text{m}\times1.2\,\text{m}$\par\bigskip
