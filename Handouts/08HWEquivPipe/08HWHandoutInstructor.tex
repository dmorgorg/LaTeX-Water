	...
	\cbox{
		\begin{align*}
			\frac{v_A^2-v_D^2}{2g} & = \frac{\left(\frac{20.955/1000}{\pi(0.150)^2/4}\right)^2-\left(\frac{20.955/1000}{\pi(0.250)^2/4}\right)^2}{19.62} \\
			                       & = 0.062381\,\text{m}                                                                                                
		\end{align*}
		This is approximately $0.15\%$ ($1/667\,\text{th})$ of the pressure head at $D$.
...
\minit[0.45]{
	\cbox{
		\begin{align*}
			Q_{BCD_\text{equiv}} & = \frac{100 (166.98)^{2.63}\left(\frac{10}{1000}\right)^{0.54}}{279000} \\
			                     & = 21.895\,\text{L/s}                                                    \\\\
...
\minit[0.44]{
	...
	\cbox{
		\begin{align*}
			D_{BDC\text{equiv}}        & =\left( \frac{279000\times 100}{100\left(\frac{49.576}{1000}\right)^{0.54}} \right)^{0.3802} \\\\
...
\minit[0.45]{
	\cbox{
		\begin{align*}
			Q_{BC_\text{upper}}  & = \frac{150 (275)^{2.63}\left(\frac{10}{2037.1}\right)^{0.54}}{279000}  \\
			                     & = 79.262\,\text{L/s}                                                    \\\\
			Q_{BDC_\text{equiv}} & = \frac{100 (217.92)^{2.63}\left(\frac{10}{1000}\right)^{0.54}}{279000} \\
			                     & = 42.084\,\text{L/s}                                                    \\\\
			Q_{BC_\text{equiv}}  & = 79.262+42.084  \,\text{L/s}                                           \\
			                     & = 121.35\,\text{L/s}                                                    
		\end{align*}
	}
	\parb
	Determine the diameter of the equivalent pipe, with length of $1000\,\text{m}$ and resistance coefficient of $100$, that has a headloss of  $121.35\,\text{m}$ for a flow of $100\,\text{L/s}$.
	\cbox{
		\begin{align*}
			D_{BC\text{equiv}}        & =\left( \frac{279000\times 100}{100\left(\frac{121.35}{1000}\right)^{0.54}} \right)^{0.3802} \\\\
			\bm{D_{BC\textbf{equiv}}} & =\bm{181.33}\,\textbf{mm}                                                                    
		\end{align*}
	}
	\parb
	...
	\cbox{	%
		\begin{align*}
			h_{L_{AB}}             & = 122.5\left( \frac{279000\times 100}{125(500)^{2.63}} \right)^{1.852}   \\
			                       & = 0.070450\,\text{m}                                                     \\\\
			h_{L_{BC\text{equiv}}} & = 1000\left( \frac{279000\times 100}{100(181.33)^{2.63}} \right)^{1.852} \\
			                       & = 121.56\,\text{m}                                                       \\\\
			h_{L_{CE\text{equiv}}} & = 1000\left( \frac{279000\times 100}{100(500)^{2.63}} \right)^{1.852}    \\
			                       & = 0.0057510\,\text{m}                                                    \\\\
			h_{L_{AE}}             & = 0.070450+121.56+0.0057510                                              \\
			                       & = 121.64 \,\text{m}                                                      
		\end{align*}
	}
}
\hfill
\minit[0.45]{
	Find the equivalent pipe that has a headloss of $121.64\,\text{m}$ for a flow of $100\,\text{L/s}$:
	\cbox{
		\begin{align*}
			D_{AE\text{equiv}} & = \left( \frac{279000\times 100}{100\left(\frac{121.64}{1000}\right)^{0.54}}  \right)^{0.3802} \\
			                   & = 181.24\,\text{mm}                                                                            
		\end{align*}
	}
	\parb
	...
	\cbox{
		\begin{align*}
			Q_{AE\text{equiv}} & =  \frac{100 (181.24)^{2.63}\left(\frac{6.7}{1000}\right)^{0.54}}{279000} \\
			                   & = 20.878\,\text{L/s}                                                      \\\\
			\bm{Q_{AE}}        & = \bm{20.9}\,\textbf{L/s}                                                 
		\end{align*}
