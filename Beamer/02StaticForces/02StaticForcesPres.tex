...
\begin{frame}
	...
	\cmini{
		\begin{myexam}[colframe=example!85!black, colbacktitle=example!85!black]{}{}
...
%\begin{frame}
%\begin{cfig}[0.6]{../../figs/02StaticForces/03staticforces01}\end{cfig}
%\end{frame}
...
%\begin{frame}
%\begin{cfig}[0.95]{../../figs/02StaticForces/03staticforcesEx3}\end{cfig}
%\end{frame}
...
%\begin{frame}
%\begin{cfig}[0.85]{../../figs/02StaticForces/03staticforcesEx04}\end{cfig}
%\end{frame}
...
\begin{frame}%{Forces on Submerged Rectangle (Exercise)}
	\cmini{
		\begin{myexam}{}{}
			...
			are two rectangular hatches in the wall.
			
			\bigskip
			
			The top of one hatch is at a depth of 1.25~m; the hatch is 2.25~m wide
			$\times$ 1.5~m high. What is the magnitude of the force exerted
...
\begin{frame}%{Forces on Submerged Rectangle (Exercise)}
	\cmini{
		\begin{myexer}{}{}
			...
			The second hatch has dimensions 3.75~m wide $\times$ 1.6~m high. At
			...
			\begin{itemize}
				...
				\begin{frame}
					...
					\begin{mybox}[width=9cm,colframe=example]
						\begin{cfig}[0.6]{../../figs/02StaticForces/03staticforcesEx06a}\end{cfig}
					\end{mybox}
					
					\begin{myexam}[width=10.875cm,colframe=example,colbacktitle=example]{}{}
						\raggedright
				...
				%\begin{frame}
				%\begin{cfig}[0.95]{../../figs/02StaticForces/03staticforcesEx06a}\end{cfig}
				%\end{frame}
				...
				\begin{frame}
					...
					\begin{cfig}[0.3]{../../figs/02StaticForces/03staticforcesEx07a}\end{cfig}
					\vspace{-0.5cm}
				...
				%\begin{frame}
				%\begin{cfig}[0.45]{../../figs/02StaticForces/03staticforcesEx07a}\end{cfig}
				%\end{frame}
				...
				\begin{frame}{Centre of Pressure}
					\begin{columns}
						\begin{column}{0.45\textwidth}
							\only<1>{
								\begin{cfig}[0.5]{../../figs/02StaticForces/03staticforces09a}\end{cfig}
								}\only<2>{
								\begin{cfig}[0.9]{../../figs/02StaticForces/03staticforces09b}\end{cfig}
								}\only<3>{
								\begin{cfig}[0.9]{../../figs/02StaticForces/03staticforces09c}\end{cfig}
								}\only<4>{
								\begin{cfig}[0.9]{../../figs/02StaticForces/03staticforces09d}\end{cfig}
								}\only<5>{
								\begin{cfig}[0.9]{../../figs/02StaticForces/03staticforces09e}\end{cfig}
							}
						\end{column}
						\begin{column}{0.5\textwidth}
							\begin{itemize}
								...
								\begin{frame}{Centre of Pressure}
									\begin{columns}
										\begin{column}{0.45\textwidth}
											\begin{cfig}[0.7]{../../figs/02StaticForces/03staticforces12}\end{cfig}
										\end{column}
										\begin{column}{0.5\textwidth}
											\smallskip
											\begin{itemize}
								...
								\begin{frame}
									...
									\begin{columns}
										...
										\begin{column}{0.575\textwidth}
											\begin{myexam}[colbacktitle=example, colframe=example]{}{}
												\raggedright
								...
								\begin{frame}
									\begin{cfig}[0.8]{../../figs/02StaticForces/03staticforcesEx09a}\end{cfig}
								\end{frame}
								...
								\begin{frame}
									\begin{columns}
										\begin{column}{0.6\textwidth}
											\begin{mybox}
												\begin{cfig}[0.65]{../../figs/02StaticForces/03staticforcesEx08a}\end{cfig}
											\end{mybox}
								...
								\begin{frame}
									\begin{cfig}[0.8]{../../figs/02StaticForces/03staticforcesEx08a}\end{cfig}
								\end{frame}
								...
								\begin{frame}
									...
									\begin{textblock*}{5cm}(4cm,-0.5cm)
										\begin{cfig}[0.75]{../../figs/02StaticForces/03staticforcesEx10}\end{cfig}
									\end{textblock*}
								...
								\begin{frame}
									\begin{cfig}[0.85]{../../figs/02StaticForces/03staticforcesEx10}\end{cfig}
								\end{frame}
								...
								\begin{frame}
									% 	\setbeamercolor{block title}{bg=yellowgreen}
									\begin{columns}
										\begin{column}{0.55\textwidth}
											\begin{mybox}
								...
								\begin{frame}
									\begin{cfig}[0.5]{../../figs/02StaticForces/03staticforcesEx12}\end{cfig}
								\end{frame}
