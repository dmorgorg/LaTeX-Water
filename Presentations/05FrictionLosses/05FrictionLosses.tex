...
\begin{frame}{Velocity Profiles}
	...
	\begin{textblock*}{5cm}(6cm, 1.75cm)
		\only<2-3>{
			\begin{cfig}[0.35]{../../figs/05FrictionLosses/05FrictionVelocityProfileLaminarA.pdf}\end{cfig}
		}
	\end{textblock*}
...
\begin{frame}
	...
	\begin{textblock*}{0.95\columnwidth}(1.3cm, 2cm)
		\only<1>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/moody}\end{cfig}
		}
		\only<2>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx3A}\end{cfig}
		}
		\only<3>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx3B}\end{cfig}
		}
		\only<4>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx3C}\end{cfig}
		}
		\only<5>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx3D}\end{cfig}
		}
	\end{textblock*}
...
\begin{frame}
	...
	\begin{textblock*}{0.95\columnwidth}(1.3cm, 2cm)
		...
		\only<2>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx4A}\end{cfig}
		}
		\only<3>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx4B}\end{cfig}
		}
		\only<4>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx4C}\end{cfig}
		}
		\only<5>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx4D}\end{cfig}
		}
	\end{textblock*}
...
\begin{frame}
	...
	\begin{textblock*}{1\columnwidth}(1cm, 2cm)
		...
		\only<2>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx5B}\end{cfig}
		}
		\only<3>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx5C}\end{cfig}
		}
		\only<4-5>{
			\begin{cfig}[0.5]{../../figs/05FrictionLosses/05FrictionLossesEx5D}\end{cfig}
		}
	\end{textblock*}
