...
\begin{frame}
	% \vspace{-0.75cm}
	\imgboxbg{0.375}{../../figs/08HWEquivPipe/HW17ink.pdf}{structure}{1pt}{0.25cm}
	\begin{myexer}{}{}
		Determine $Q$. All pipes are horizontal. Disregard minor losses.
	\end{myexer}
	\pause
	\raggedright
	\cmini[0.9]{
		...
		\begin{enumerate}
			...
			\item Calculate the headloss for the system
...
\begin{frame}{Minor Losses}
	\cmini{
		It is simple to incorporate minor losses into the equivalent pipe methods we have used.
		\parb
		For pipes with valves or fittings, calculate and use the effective length of the pipes rather than the actual length. All other calculations remain the same.
	}
\end{frame}
...
\begin{frame}{}
	\begin{myexer}{}{}
		\cfig[0.5]{../../figs/08HWEquivPipe/MT1A}
		\hspace{-0.25cm}
		\mini[0.45]{
			\footnotesize
			\vspace{-1cm}
			\begin{tabular}{ccc}
				...
				\midrule
				\includegraphics[scale=0.125]{../../figs/08HWEquivPipe/checkvalve} & Check Valve & 100    \\
				\midrule
				\includegraphics[scale=0.5]{../../figs/08HWEquivPipe/elbow}        & Elbow       & 50     \\
				\midrule
				\includegraphics[scale=0.15]{../../figs/08HWEquivPipe/footvalve}   & Foot Valve  & 75     \\
				\midrule
