...
\begin{frame}{}
	\cmini[0.9]{
		\begin{myexam}{}{}
			\begin{enumerate}[a]
				\item Determine the diameter of a pipe with length $L=1000\,\text{m}$ and resistance coefficient $C=100$ that is equivalent to $1685\,\text{m}$ of new Schedule $40$ $18$-in steel pipe ($d=428.7\,\text{mm}, C=130$).
				\item Verify that the equivalent pipe is hydraulically equivalent at flows of
			\end{enumerate}
